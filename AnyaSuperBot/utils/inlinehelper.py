...
from AnyaSuperBot import OWNER_ID, pgram, arq
from AnyaSuperBot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from AnyaSuperBot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/AnyaSuperBot?start=start"),
...
async def alive_function(answers):
   ...
   # ubot_state = 'Dead' if not await app2.get_me() else 'Alive'
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/AnyaSuperBot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Anya  剣](https://t.me/AnyaSuperBot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/AnyaSuperBot) | [OWNER](t.me/Xelcius)
"""
