...
from AnyaSuperBot import dispatcher  # BAN_STICKER
...
from AnyaSuperBot.modules.helper_funcs.chat_status import (
    is_user_admin,
    bot_admin,
    user_admin_no_reply,
    user_admin,
...
from AnyaSuperBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user_and_text,
    extract_user,
)
from AnyaSuperBot.modules.helper_funcs.filters import CustomFilters
from AnyaSuperBot.modules.helper_funcs.misc import split_message
from AnyaSuperBot.modules.helper_funcs.string_handling import split_quotes
from AnyaSuperBot.modules.log_channel import loggable
from AnyaSuperBot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/AnyaSuperBot?start={}".format(chat.id)
                    )
                ]
            ]
        )
