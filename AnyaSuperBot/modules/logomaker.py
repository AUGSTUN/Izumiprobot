...
from AnyaSuperBot import OWNER_ID
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./AnyaSuperBot/LOGO_FONT/*")
    ...
    fname = "fallen.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Logo Created By @AnyaSuperBot")         
    await pesan.delete()
