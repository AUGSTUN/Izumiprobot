...
import AnyaSuperBot.modules.sql.global_bans_sql as gban_sql
import AnyaSuperBot.modules.sql.users_sql as user_sql
from AnyaSuperBot import DEV_USERS, OWNER_ID, dispatcher
