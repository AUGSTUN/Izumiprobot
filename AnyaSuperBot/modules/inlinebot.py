...
from AnyaSuperBot.modules.helper_funcs.miku_misc import article
from AnyaSuperBot.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Saber",
            "description": "AnyaSuperBot Inline",
